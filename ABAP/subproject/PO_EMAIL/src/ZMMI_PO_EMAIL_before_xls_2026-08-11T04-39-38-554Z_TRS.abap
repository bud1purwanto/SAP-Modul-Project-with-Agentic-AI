...
*     --- 4e-1. Identifikasi grup approver (OPT) ---
      ...
      ELSE.
*       T1: hanya Purchasing Group dengan mapping APPROVER aktif.
*       Tidak ada fallback DEFAULT agar group di luar scope tidak terkirim.
      ...
      ELSE.
        ...
        ELSE.
          LS_RESULT-MESSAGE = 'Tidak diproses: Purchasing Group tidak ada dalam scope APPROVER aktif'.
        ENDIF.
      ENDIF.
