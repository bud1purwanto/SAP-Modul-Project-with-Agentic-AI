...
FORM F_DISPLAY_ALV.
  ...
  PERFORM F_ADD_FIELDCAT USING 'USDVAL' 'Nilai (USD)' 18 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'TIER' 'Tier' 6 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'APPR_OPT' 'Grup Approver' 15 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'APPR_NAME' 'Approver' 25 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'APPR_MAIL' 'Email' 35 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'EXC_FLAG' 'Flag' 6 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'EXC_REASON' 'Alasan Exception' 60 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'STATUS' 'Status' 6 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'MESSAGE' 'Keterangan' 60 SPACE.
