...
FORM GET_DATA.
  DATA : TEXT1 TYPE C LENGTH 25,
         ...
         LV_MIN_DISP TYPE P DECIMALS 2,
         LV_MAX_DISP TYPE P DECIMALS 2.
  ...
  LOOP AT IT_LOT.
    ...
    IF SY-SUBRC EQ 0.
      ...
      IT_MIC1-UOM = GV_UOM.
          ...
          " Format FLTP tolerance through packed decimals for screen 0100.
          CLEAR: LV_MIN_DISP, LV_MAX_DISP.
          LV_MIN_DISP = IT_MIC1-MICMIN.
          LV_MAX_DISP = IT_MIC1-MICMAX.
          WRITE LV_MIN_DISP TO WA_DATA-MICMIN
                DECIMALS 2 LEFT-JUSTIFIED.
          WRITE LV_MAX_DISP TO WA_DATA-MICMAX
                DECIMALS 2 LEFT-JUSTIFIED.
