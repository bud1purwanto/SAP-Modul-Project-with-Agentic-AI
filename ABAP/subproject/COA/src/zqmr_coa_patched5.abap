...
FORM GET_TRACED_LOTS.
  ...
  IF LOT_SR_CONV IS INITIAL.
    ...
    " --- END FALLBACK WRAPPER ---
      ...
      " --- BEGIN FALLBACK 2 (Carton) ---
      " Jika JR masih gagal ditemukan, periksa apakah ini Carton (menggunakan atribut Mother Roll)
      IF L_JR_CONV_BATCH IS INITIAL AND IT_DATA-NOMSR IS NOT INITIAL.
        CLEAR L_MROLL_L.
        ...
        IF L_MROLL_L IS NOT INITIAL.
          SELECT SINGLE OBJEK INTO LV_SR_OBJEK FROM AUSP
            WHERE ATINN = ATINN_ROLL
              ...
              AND KLART = '023'.
          IF SY-SUBRC = 0.
            SELECT SINGLE CHARG INTO L_JR_CONV_BATCH FROM MCH1 WHERE CUOBJ_BM = LV_SR_OBJEK.
          ENDIF.
        ENDIF.
      ENDIF.
      " --- END FALLBACK 2 ---
