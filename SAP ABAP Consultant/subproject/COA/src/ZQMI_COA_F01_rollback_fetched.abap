    ...
    LOOP AT LT_CFG.
      ...
      CASE LT_CFG-FIELD_NAME.
        ...
        WHEN 'PO_NUMBER' OR 'PO_NUM'.
          SELECT SINGLE BSTKD INTO LV_RAW_VAL FROM VBKD WHERE VBELN = LT_BATCHES-VBELN.
        ...
        WHEN 'EXPIRED_DATE' OR 'EXP_DATE'.
          SELECT SINGLE VFDAT INTO LV_RAW_VAL FROM MCH1 WHERE CHARG = LT_BATCHES-CHARG.
        WHEN 'PRODUCTION_DATE' OR 'PROD_DATE' OR 'MANUFACTURING_DATE' OR 'MFG_DATE'.
          SELECT SINGLE HSDAT INTO LV_RAW_VAL FROM MCH1 WHERE CHARG = LT_BATCHES-CHARG.
        WHEN 'USED_BEFORE'.
          SELECT SINGLE VFDAT INTO LV_RAW_VAL FROM MCH1 WHERE CHARG = LT_BATCHES-CHARG.
        ...
        WHEN 'SO_NUMBER' OR 'SO_NUM'.
          SELECT SINGLE VGBEL INTO LV_RAW_VAL FROM LIPS WHERE VBELN = LT_BATCHES-VBELN AND POSNR = LT_BATCHES-POSNR.
