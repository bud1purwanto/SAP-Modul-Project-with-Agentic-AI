...
* <<< END OF NEW CODE
  ...
  LOOP AT ITAB.
    ...
    IF ITAB-MATNR IS INITIAL AND ITAB-MIC IS INITIAL AND ITAB-KUNNR IS INITIAL AND ITAB-METHOD IS INITIAL AND ITAB-UOM IS INITIAL AND ITAB-MAPPING IS INITIAL.
      CONTINUE.
    ENDIF.
...
FORM F_CHANGE_DATA.
  ...
  LOOP AT ITAB.
    ...
    IF SY-SUBRC EQ 0.
      IF ITAB_TEMP-MAPPING NE ITAB-MAPPING OR ITAB_TEMP-METHOD NE ITAB-METHOD OR ITAB_TEMP-UOM NE ITAB-UOM.
