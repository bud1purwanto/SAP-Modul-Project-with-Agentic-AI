...
PARAMETERS: P_RPT  RADIOBUTTON GROUP G1 DEFAULT 'X',
...
* Kolom kunci dan exception diletakkan lebih awal untuk pembacaan cepat.
  PERFORM F_ADD_FIELDCAT USING 'EBELN' 'No. PO' 12 'X'.
  PERFORM F_ADD_FIELDCAT USING 'LIFNR' 'Vendor' 12 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'USDVAL' 'Nilai PO (USD)' 20 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'TIER' 'Tier' 8 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'EXC_FLAG' 'Flag Exception' 12 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'EXC_REASON' 'Alasan Exception' 45 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'APPR_OPT' 'Grup Approver' 16 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'APPR_NAME' 'Approver' 22 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'APPR_MAIL' 'Email Penerima' 35 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'STATUS' 'Status' 8 SPACE.
  PERFORM F_ADD_FIELDCAT USING 'MESSAGE' 'Keterangan' 75 SPACE.
