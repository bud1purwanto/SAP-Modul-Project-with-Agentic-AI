...
* Legenda arti flag exception (biar approver paham)
  ...
  IF LV_RULE_STALE EQ 'X'.
    ...
    CONDENSE LV_NUM.
    CONCATENATE LV_LINE LV_NUM 'hari).</li>' INTO LV_LINE SEPARATED BY SPACE.
    PERFORM F_ADD_HTML USING LV_LINE.
  ENDIF.

* Tampilkan setiap kategori aktif supaya penambahan multirow terlihat.
