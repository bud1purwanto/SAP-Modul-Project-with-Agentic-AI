...
*&  notifikasi email per grup approver (multi-recipient, HTML+CSV).
...
*----------------------------------------------------------------*
CONSTANTS: GC_NEW_DAYS   TYPE I              VALUE 90,     " master baru
...
*    TEXT3 = gender utk sapaan (M/F/kosong).
*----------------------------------------------------------------*
  REFRESH LT_APPROVER.
...
* CSV row
  ...
  ELSE.
    LV_FLAG = 'OK'.
  ENDIF.
  CONCATENATE LV_EBELN P_MAIL-LIFNR LV_USD P_MAIL-TIER LV_FLAG LV_REAS
